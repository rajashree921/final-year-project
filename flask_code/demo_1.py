...
def predict():
  if request.method == 'POST' and request.files['file']:
    ...
    text_img = Final_textreader(image)
    pred_clf_inception = inception_one_image(image, new_inception=new_inception) #new_inception prediction
    ...
    # os.remove(filename)
    return render_template('predict.html',fn = filename, result_table = resultats.to_html())
